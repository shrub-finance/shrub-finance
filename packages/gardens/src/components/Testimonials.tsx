...
const testimonials1 = [
  {
    content:
      "The first step in Shrub series is to ensure great community building. It was a lottery open to everyone. No “invite 10 to get wl” where mostly botters win. Everyone who was in discord at snapshot had their chance. If you were active in the community, for example, helped with beta tests, you got significantly increased chances. I find this process quite fair and rewarding.  — Wazzup",
  },
  {
    content:
...
function Testimonials() {
  const testimonialsRow1 = testimonials1.map((element, index) => {
    return (
      <Container pb={10}>
        <Flex
          boxShadow={"xl"}
  ...
  const testimonialsRow2 = testimonials2.map((element, index) => {
    return (
      <Container pb={10}>
        <Flex
          boxShadow={"xl"}
  ...
  return (
    <>
      <HStack display={{ base: "none", md: "flex" }}>{testimonialsRow1}</HStack>
      <HStack display={{ base: "none", md: "flex" }}>{testimonialsRow2}</HStack>
