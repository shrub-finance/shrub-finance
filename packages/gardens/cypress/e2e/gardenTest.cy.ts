describe("Garden Test", () => {
  it("passes", () => {
    ...
    cy.get("@nav")
      .find("nav")
      .should("have.class", "css-1rhcjh7")
      .children()
      .as("navChildren");
    cy.get("@navChildren").should("have.length", 5);
    cy.get("@navChildren").first().should("have.attr", "href", "/my-garden");
    cy.get("@navChildren").eq(1).should("have.attr", "href", "/chapters");
    cy.get("@navChildren").eq(2).should("have.attr", "href", "/leaderboard");
    ...
    cy.get("@nav")
      ...
      .as("secondDiv");
    cy.get("@secondDiv").children().first().should("have.text", "Buy MATIC");
    cy.get("@secondDiv").children().eq(1).should("have.text", "Roadmap");
    cy.get(".css-1pg4s0")
      .find("h2")
    ...
    cy.get("@bodyChildren")
      ...
      .and("have.text", "Connect with the core team, and get detailed updates");
    cy.get("@bodyChildren")
      .first()
      .should("have.class", "css-1w94zre")
      .children()
