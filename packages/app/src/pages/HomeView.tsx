    ...
    return (
        <>
                    ...
                    <Box mb={10}>
                        ...
                        <Flex
                            ...
                            {!isMobile ?  <Box
                                ...
                                <Box p={6}>
                                    <Stack py={6} align={'center'}>
                                        <Circle w="100px" h="100px" bg={step1complete ?  connectedStepBg :stepsBg} color={step1complete ? connectedStepColor :stepsColor}>
                                    ...
                                    <Stack align={'center'}>
                                        <Heading fontSize={'xl'} fontWeight={"500"}>
                                            {step1complete && <PolygonIcon/> } {step1complete ? 'Mumbai' :  !!web3Error && getErrorMessage(web3Error).title === "Wrong Network" ? "Connect to Mumbai" : "Connect Wallet" }
                                        </Heading>
                                    ...
                                    <Button
                                        ...
                                        _hover={step1complete ? {
                                            ...
                                            boxShadow: 'lg',}}>
                                        {step1complete ? 'Connected' : !!web3Error && getErrorMessage(web3Error).title === "Wrong Network" ? "Connect to Mumbai" : "Connect Wallet" }
                                    </Button>
                                </Box>
                            </Box> :
                            <Button
                            ...
                            {!isMobile ? <Box
                                ...
                                <Box p={6}>
                                    <Stack py={6} align={'center'}>
                                        <Circle w="100px" h="100px" bg={ step2complete ? connectedStepBg: stepsBg } color={ step2complete ? connectedStepColor: stepsColor }>
                                            <Box as="span" fontWeight="bold" fontSize="6xl">
                            ...
                            <Box p={6}>
                                    <Stack py={6} align={'center'}>
                                        <Circle w="100px" h="100px" bg={step3complete ? connectedStepBg : stepsBg}
                  ...
                  <Box maxW='60rem' mb={8} textAlign={'center'}>
                      ...
                      <Button
                        ...
                        _hover={{ transform: 'translateY(-2px)' }}
                         bgGradient={step1complete && step2complete && step3complete ? "linear(to-r,#74cecc,green.300,blue.400)": undefined}
          ...
          >
            ...
            <Modal isOpen={isConnectWalletOpen} onClose={onConnectWalletClose} motionPreset="slideInBottom" scrollBehavior={isMobile ?"inside" : "outside"}>
                <ModalOverlay />
