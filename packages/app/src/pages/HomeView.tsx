...
import RadioCard2 from "../components/Radio2";
        ...
        <>
            ...
            <Modal  motionPreset="slideInBottom" size={"lg"} isOpen={isOpen}  onClose={onClose}>
                ...
                <ModalContent borderRadius="2xl">
                    <ModalCloseButton />
                    <ModalHeader borderBottomWidth="1px">Insta Trade Order</ModalHeader>
                    <ModalBody>
                        <Box>
                            <Flex>
                                <Box id={"order form"}>
                                    <Stack spacing="24px">
                                        ...
                                        <Alert status="info" borderRadius={"2xl"} bgColor={useColorModeValue("gray.100", "shrub.300")}>
                                            <AlertIcon />
                                            You are about to buy a PUT option at 3000 SUSD strike price set to expire on October 30.
                                        </Alert>
                                        <Box>
