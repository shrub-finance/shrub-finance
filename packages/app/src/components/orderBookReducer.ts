import { OrderBookAction, OrderBookState } from "../types";
    ...
    case "add":
      for (const order of orders) {
        ...
        if (optionAction === "BUY") {
          ...
          positionPointer.buyOrders = Object.values(
            positionPointer.buyOrdersIndexed
          );
          ...
          positionPointer.sellOrders = Object.values(
            positionPointer.sellOrdersIndexed
          );
